...
const TERMS: { term: string; definition: string }[] = [
  { term: 'Étirement', definition: 'Phase de mouvement directionnel fort du prix, premier temps de la méthode EAR.' },
  { term: 'Accélération', definition: 'Accélération du mouvement confirmant la direction après l\'étirement.' },
  { term: 'Retour', definition: 'Zone de résistance ou de retournement marquant la fin du mouvement.' },
